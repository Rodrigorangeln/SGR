    ...
    <div class="col-sm-3">
      ...
      <div class="form-group mt-4">
        ...
        <div class="form-inline">
          <input class="form-control col-sm-4" id="nf" maxlength="7" required data-toggle="tooltip" data-placement="right" title="INFORME A NF de SAÍDA">
          <button id="btn_NF" class="ml-2 btn btn-primary" type="button">OK</button>
        </div>
      </div>
      <div class="form-group">
        <label>Quant. de Caixas</label>
        <input class="form-control col-sm-4" id="nf" maxlength="5" required data-toggle="tooltip" data-placement="right" title="INFORME a QUANTIDADE de CAIXAS na NF">
      </div>
    </div>
