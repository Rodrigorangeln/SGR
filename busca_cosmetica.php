...
switch ($acao) {
	...
	case "grava_cosmetica":
		grava_cosmetica($user, $connect, $_POST['rrm'], $_POST['s1'], $_POST['cosm0'], $_POST['cosm1'], $_POST['cosm2'], $_POST['cosm3'],	$_POST['selec_cosm0'], $_POST['selec_cosm1'], $_POST['selec_cosm2'], $_POST['selec_cosm3']);
		break;
	}
...
function grava_cosmetica($user, $connect, $rrm, $s1, $cosm0, $cosm1, $cosm2, $cosm3, $selec_cosm0, $selec_cosm1, $selec_cosm2, $selec_cosm3){
	if ($cosm0 <> ""){
